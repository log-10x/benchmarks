...
## The label's best case: the type first in the sort key
...
|---|---|---:|---:|---:|---:|
| `bt_type_label` | one type by label, type-first key | 71 | 75 | 9,718,849 | 4,868,824 |
